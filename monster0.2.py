...
def approval():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/monsterrulex/monster0.2/blob/main/approval.txt').text
    if id in httpCaht:
      ...
      print('\33[1;37m----------------------------------------------')
      print ('Tool Owner: MONSTER -')
      print("Your Token : "+id)
      input('IF U WANT TO BUY THEN PRESS ENTER ')
      tks = ('Hello%20MONSTER%20!%20Please%20Approve%20My%20Token%20My%20Token%20Is%20:%20'+id)
      os.system('am start https://wa.me/+923196101378?text='+tks)
      approval()
      time.sleep(1)
